...
const EmailVerificationPage = () => {
    ...
    const handleChange = (index, value) => {
        ...
        if(value.length > 1){
            ...
            //move focus to the next input filed if value is entred
            if(value && index < 5){
            ...
            <div className='flex justify-between'>
                ...
                {code.map((digit,index) =>(
                    <input
                     ...
                     className='w-12 h-12 text-center text-2xl font-bold bg-gray-700 text-white border-2 border-gray-100 rounded-lg focus:border-green-400 focus:outline-none'
                    />
                ))}
